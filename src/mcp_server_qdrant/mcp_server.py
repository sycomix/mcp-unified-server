...
class QdrantMCPServer(FastMCP):
    ...
    def setup_tools(self):
        ...
        async def request_planning(
                ...
                tasks: Annotated[
                    List[Dict[str, str]], Field(description="A list of tasks, each with a title and description.")],
                splitDetails: Annotated[
                    Optional[str], Field(description="Details about how the request was split into tasks.")] = None,
        ) -> Dict[str, Any]:
        ...
        async def update_task(
                ...
                requestId: Annotated[str, Field(description="The ID of the request.")],
                taskId: Annotated[str, Field(description="The ID of the task.")],
                updates: Annotated[Dict[str, str], Field(
                    description="A dictionary containing the fields to update (title and/or description).")],
        ) -> Dict[str, Any]:
